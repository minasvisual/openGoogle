...
var openGoogle = (function () {
    ...
    var loginURL = 'https://accounts.google.com/o/oauth2/v2/auth',
        ...
        logoutURL = 'https://accounts.google.com/o/oauth2/v2/revoke',
    ...
    function logout(callback) {
        ...
        if (token) {
            logoutWindow = window.open(logoutURL + '?token=' + token + '&next=' + logoutRedirectURL, '_blank', 'location=no,clearcache=yes');
            if (runningInCordova) {
                setTimeout(function() {
                    logoutWindow.close();
                }, 700);
    ...
    function api(obj) {
        ...
        url = 'https://www.googleapis.com' + obj.path + '?' + toQueryString(params);
